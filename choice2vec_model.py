...
def prepare_behavioral_data(df: pd.DataFrame, 
    ...
    Returns:
        behavioral_features: [num_windows, window_size, 2] (choice, rt)
        environmental_features: [num_windows, window_size, 3] (value_diff, trial_in_subtask, subtask)
        states: [num_windows, window_size] (engagement states)
    """
    
    # Define feature columns
    behavioral_cols = ['choice', 'rt']
    environmental_cols = ['value_difference', 'trial_in_subtask', 'subtask']
