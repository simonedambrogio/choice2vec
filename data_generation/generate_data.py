...
def main():
    ...
    # Save data
    df.to_csv('results/behavioral_data.csv', index=False)
    print(f"Data saved to results/behavioral_data.csv")
    ...
    generator.plot_data_summary(df, 'results/behavioral_data_summary.png')
